...
int  main(void)
{
    ...
    uint32 i;
   (*((volatile unsigned long *) 0xE002C000)) = 0x00;		
   (*((volatile unsigned long *) 0xE002C004)) = 0x00;
   (*((volatile unsigned long *) 0xE0028008)) = 0xffffffff;			
   (*((volatile unsigned long *) 0xE0028004))=0x66;
   while(1)	
   {  
   for(i=0;i<14;i++)            
   { (*((volatile unsigned long *) 0xE002800C))= ~(table[i]<<0);
     (*((volatile unsigned long *) 0xE0028004))=(table[i])<<0;
     DelayNS(80);
   }
   }
}
