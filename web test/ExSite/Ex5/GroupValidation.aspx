    ...
    <form id="form1" runat="server">
        <table class="auto-style1">
            <tr>
                ...
                &nbsp;
                    <asp:Button ID="btnValidataName" runat="server" OnClick="btnValidataName_Click" Text="用户名是否可用" ValidationGroup="groupName" />
...
&nbsp;<asp:RangeValidator ID="rvBirthday" runat="server" ControlToValidate="txtBirthday" Display="Dynamic" ErrorMessage="日期映在1900-1-1到2020-1-1之间！" MaximumValue="2020-1-1" MinimumValue="1900-1-1" SetFocusOnError="True" Type="Date"></asp:RangeValidator>
                </td>
            </tr>
            <tr>
